...
namespace BHFanShop.Services
{
    public static class PlayerData
    {
        ...
        public static ObservableCollection<Player> U19Team = new ObservableCollection<Player>
        {
            ...
            new Player { Name = "Dragan Pejić", Club = "FK Borac Banja Luka U19", Position = "Krilo", Image = "notfound.jpeg" },
            new Player { Name = "Mehmed Šehić", Club = "NK Čelik Zenica U19", Position = "Krilo", Image = "notfound.jpeg" },

            new Player { Name = "Din Ramić", Club = "FC Zürich U21", Position = "Napadač", Image = "notfound.jpeg" },
            new Player { Name = "Said Nišić", Club = "RB Salzburg U18", Position = "Napadač", Image = "notfound.jpeg" },
            new Player { Name = "Antonio Arapović", Club = "HŠK Zrinjski Mostar U19", Position = "Napadač", Image = "notfound.jpeg" }
        };
